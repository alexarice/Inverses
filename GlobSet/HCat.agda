...
record HCat {i : Size} (G : GlobSet i) ⦃ _ : Composable G ⦄ : Set₁ where
  ...
  interchange₁ : {j : Size< i} {k : Size< j} {l : Size< k} {x y z : cells G} → {a b c : cells (morphisms G j x y)} → {d e f : cells (morphisms G j y z)} → (α : cells (morphisms (morphisms G j x y) k a b)) → (β : cells (morphisms (morphisms G j y z) k d e)) → (γ : cells (morphisms (morphisms G j x y) k b c)) → (δ : cells (morphisms (morphisms G j y z) k e f)) → cells (morphisms (morphisms (morphisms G j x z) k (comp1 d a) (comp1 f c)) l (comp1 {G = morphisms G j x z} ⦃ compHigher j x z ⦄ (comp2 δ γ) (comp2 β α)) (comp2 (comp1 {G = morphisms G j y z} ⦃ compHigher j y z ⦄ δ β) (comp1 {G = morphisms G j x y} ⦃ compHigher j x y ⦄ γ α)))
  interchange₁ {j} {k} {l} {x} {y} {z} {a} {b} {c} {d} {e} {f} α β γ δ = eq {{prodComp
                  (morphisms (morphisms G j y z ×G morphisms G j x y) k (e , b)
                   (f , c))
                  (morphisms (morphisms G j y z ×G morphisms G j x y) k (d , a)
                   (e , b)) {{Composable.compHigher
                                (prodComp (morphisms G j y z) (morphisms G j x y) {{compHigher j y z}} {{compHigher j x y}}) k (e , b)
                                (f , c)}} {{Composable.compHigher
                                              (prodComp (morphisms G j y z) (morphisms G j x y) {{compHigher j y z}} {{compHigher j x y}}) k (d , a)
                                              (e , b)}}}} {{Composable.compHigher (compHigher j x z) k
                                                              (func (comp j x y z) (d , a))
                                                              (func (comp j x y z) (f , c))}} (compPreserve {{prodComp (morphisms G j y z) (morphisms G j x y) {{compHigher j y z}} {{compHigher j x y}}}} {{compHigher j x z}} (compPreserveComp j x y z) k l (d , a) (e , b) (f , c)) l ((δ , γ) , (β , α))
