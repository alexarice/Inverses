...
These results have been used to show that the three definitions of
...
\subsubsection{\texorpdfstring{\(\omega\)}{Omega}-Categories}\label{sec:categories}
