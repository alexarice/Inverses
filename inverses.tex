  ...
  \item \(\gamma_f\) is given by the following diagram:
    \begin{center}
      \begin{tikzpicture}[rounded corners=5pt]
        ...
        \draw (G) to ++(0,-60pt) to (FRInv);
        \draw (FRInv) to ++(20pt,0pt) to ++(0pt,30pt) to (FL);
        \draw (FL) to ++(15pt,0) to[rounded corners=20pt] ++(0pt,-55pt) to (FLInv);
        \draw (FR) to ++(15pt,0pt) to[rounded corners=20pt] ++(0,-55pt) to (FLInv);
        \draw (FR) to ++(-15pt,0pt) to (G');
        ...
        \draw (G1) to ++(0,-40pt) to (FRInv1);
        \draw (FRInv1) to ++(20pt,0pt) to ++(0pt,30pt) to (FL1);
        \draw (FL1) to ++(20pt,0pt) to ++(0,-80pt) to (FLInv1);
        \draw (FR1) to ++(20pt,0pt) to ++(0,-30pt) to (FLInv1);
        \draw (FR1) to ++(-20pt,0pt) to (G'1);

        \node [on grid, below right=50pt and 100pt of G1,font=\fontsize{15}{24}\selectfont] (A2) {\(\Rightarrow\)};
        \node [above=0pt of A2] (A2Text) {\((f_R)_R\)};
...
\item a bi-invertible 1-morphism from:
  \begin{center}
    \begin{tikzpicture}
      ...
      \draw (Base1) to ++(0,20pt)[out=90,in=180] to (Top1);
      \draw (Base2) to (G1);
      ...
      \draw (Base3) to ++(0,20pt)[out=90,in=180] to (Top2);
      \draw (Base4) to (G2);
      ...
      \draw (Base5) to ++(0cm,20pt)[out=90,in=180] to (Top3);
      \draw (Base6) to ++(0cm,20pt)[out=90,in=0] to (Top3);
    \end{tikzpicture}
  \end{center}
  to \(\psi_R\);
