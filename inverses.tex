...
\begin{proof}
  ...
  Which is the morphism from the proof that a right-adjoint invertible cell is also left-adjoint invertible.\todo{Add proof of this}\todo[left]{why is it invertible}
\end{proof}
